-- 00065_add_earnings_alert_job_name.sql
-- job_runs の job_name CHECK制約に 'scouter-earnings-alert' を追加
-- （決算発表アラートバッチのジョブログ用。既存慣習(00014/00019/00032/00037/
--  00039/00045/00055/00056/00063)に倣い DROP → ADD で追加する。これを忘れると job_runs への
